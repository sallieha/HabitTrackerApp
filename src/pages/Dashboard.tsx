...
function Dashboard() {
  ...
  const toggleLegend = (series: 'series1' | 'series2' | 'coffeechats') => {
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Streak & Daily Time Spent Widgets */}
      ...
      {/* My Goals Section */}
      <div className="mb-6 cursor-pointer transition-all hover:opacity-80" onClick={() => navigate('/goals')}>
